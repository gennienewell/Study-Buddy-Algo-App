...
extension FlashCard{
    static let all: [FlashCard] = [
        ...
        FlashCard(name: "Stacks", image: "code", description: "A stack is a conceptual structure consisting of a set of homogeneous elements and is based on the principle of last in first out (LIFO).", code: "Stack"),
        
        FlashCard(name: "Queues", image: "code", description: "A Queue is a conceptual structure consisting of a set of homogeneous elements and is based on the principle of first in first out (FIFO).", code: "q"),
